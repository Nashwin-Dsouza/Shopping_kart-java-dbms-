    ...
    <div class="container">
        ...
        <form action="user-login" method="post">
            <div class="form-group">
                ...
                <input type="email" id="login-email" name="login-email" class="form-control" placeholder="Enter email" required>
            </div>
            <div class="form-group">
        ...
        <form action="employeelogin.jsp" method="get">
            <input type="submit" value="Employee-Login" class="signup-btn">
        </form>
        <%
