...
<%@page import="cn.techtutorial.dao.EmployeeuserDao"%>
...
<%
EmployeeuserDao pd = new EmployeeuserDao(DbCon.getConnection());
List<Employee> products = pd.getAllOrders();
%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="row">
			...
			<div class="col-md-3 my-3">
				<div class="card w-100">
					<div class="card-body">
						<h6 class="card-title"><%=p.getUsername()%> HAS ORDER THE
							PRODUCTS:
						</h6>
						<h6 class="price">
							Product-name: <%=p.getP_name()%></h6>
						<h6 class="price">
							Product_id: <%=p.getP_id()%></h6>
						<h6 class="price">
							Order_id: <%=p.getO_id()%></h6>
						<h6 class="category">
							Category:
							<%=p.getCategory()%></h6>
						<h6 class="price">
			...
			out.println("There is no Orders");
			}
			%>
